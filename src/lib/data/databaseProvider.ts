...
export const TABLES = {
  profiles: 'mcci_profiles',
  userRoles: 'mcci_user_roles',
  sectors: 'mcci_sectors',
  tiers: 'mcci_membership_tiers',
  councils: 'mcci_councils',
  organizations: 'mcci_organizations',
  organizationUsers: 'mcci_organization_users',
  applications: 'mcci_membership_applications',
  documents: 'mcci_application_documents',
  memberships: 'mcci_memberships',
  news: 'mcci_news_posts',
  events: 'mcci_events',
  registrations: 'mcci_event_registrations',
  publications: 'mcci_publications',
  policy: 'mcci_policy_items',
  submissions: 'mcci_policy_submissions',
  msme: 'mcci_msme_programs',
  partners: 'mcci_partners',
  invoices: 'mcci_invoices',
  notices: 'mcci_member_notices',
  inquiries: 'mcci_contact_inquiries',
  subscribers: 'mcci_newsletter_subscribers',
  audit: 'mcci_audit_logs',
} as const;
